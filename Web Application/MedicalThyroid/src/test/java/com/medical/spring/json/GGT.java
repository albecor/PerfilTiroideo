...
public class GGT {
	public static void main(String args[]) throws SQLException, IOException {
		...
		dataCoding.setDisplay("GGT Gamma glutamyl transferase");
		dataCoding.setCode("2324-2");
		dataCoding.setSystem("https://r.details.loinc.org/LOINC/2324-2.html?sections=Comprehensive");
