...
public class ALP {
	public static void main(String args[]) throws SQLException, IOException {
		...
		dataCoding.setDisplay("ALP 	Alkaline phosphatase");
		dataCoding.setCode("6768-6");
		dataCoding.setSystem("https://r.details.loinc.org/LOINC/6768-6.html?sections=Comprehensive");
