...
public class ALT {
	public static void main(String args[]) throws SQLException, IOException {
		...
		dataCoding.setDisplay("ALT Alanine transaminase");
		dataCoding.setCode("1742-6");
		dataCoding.setSystem("https://r.details.loinc.org/LOINC/1742-6.html?sections=Comprehensive");
