...
@Component
public class BILIRUBINDIRECT {
	public static void main(String args[]) throws SQLException, IOException {

		Code CODE = new Code();
		DataCode dataCode = new DataCode();
		DataCoding dataCoding = new DataCoding();
		dataCoding.setDisplay("	Bilirubin.direct [Mass/volume] in Serum or Plasma");
		dataCoding.setCode("1968-7");
		dataCoding.setSystem("https://r.details.loinc.org/LOINC/1968-7.html?sections=Comprehensive");
		...
		dataValue.setUnit("mg/dL");
		dataValue.setSystem("http://unitsofmeasure.org");
		dataValue.setCode("mg/dL");
