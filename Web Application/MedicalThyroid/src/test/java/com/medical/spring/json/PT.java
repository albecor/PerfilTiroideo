...
public class PT {
	public static void main(String args[]) throws SQLException, IOException {
		...
		dataCoding.setDisplay("Prothrombin time (PT)");
		dataCoding.setCode("5902-2");
		dataCoding.setSystem("https://r.details.loinc.org/LOINC/5902-2.html?sections=Comprehensive");
