...
public class ALBUMIN {
	public static void main(String args[]) throws SQLException, IOException {
		...
		dataCoding.setDisplay("Albumin [Mass/volume] in Serum or Plasma");
		dataCoding.setCode("1751-7");
		dataCoding.setSystem("https://r.details.loinc.org/LOINC/1751-7.html?sections=Comprehensive");
