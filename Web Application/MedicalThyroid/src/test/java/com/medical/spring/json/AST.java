...
public class AST {
	public static void main(String args[]) throws SQLException, IOException {
		...
		dataCoding.setDisplay("AST Aspartate transaminase");
		dataCoding.setCode("1920-8");
		dataCoding.setSystem("https://r.details.loinc.org/LOINC/1920-8.html?sections=Comprehensive");
