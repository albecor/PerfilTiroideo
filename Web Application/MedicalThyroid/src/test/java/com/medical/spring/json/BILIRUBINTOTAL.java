...
@Component
public class BILIRUBINTOTAL {
	public static void main(String args[]) throws SQLException, IOException {

		Code CODE = new Code();
		DataCode dataCode = new DataCode();
		DataCoding dataCoding = new DataCoding();
		dataCoding.setDisplay("Bilirubin.total [Mass/volume] in Serum or Plasma");
		dataCoding.setCode("1975-2");
		dataCoding.setSystem("https://r.details.loinc.org/LOINC/1975-2.html?sections=Comprehensive");
