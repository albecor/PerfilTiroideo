...
public class TestPersonalDao {
	...
	public static void main(String args[]) {
		...
		PersonalDao personalDao = (PersonalDao) context.getBean("personalDao");
		...
		sonia.setRole("93");
		personalDao.insert(sonia);

		// find all personal
		System.out.println("call all personal");
		List<Personal> list = personalDao.selectAll();
