...
<nav class="navbar navbar-toggleable-md navbar-inverse bg-primary">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active"><spring:url value="/lab"
					var="labUrl" /> <a class="nav-link" href="${labUrl}">Inicio <span
					class="sr-only">(current)</span>
			</a></li>
		</ul>

		<ul class="navbar-nav">
			<li class="nav-item "><a class="nav-link" href="#">Laboratorista
			...
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu dropdown-menu-right">
					<spring:url value="/lab/ActualizarLaboratorista" var="updatelabUrl" />
