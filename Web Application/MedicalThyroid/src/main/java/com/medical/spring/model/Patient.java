...
public class Patient {
	...
	public String toString() {
		return "Patient [given=" + given + ", family=" + family + ", password=" + password + ", ndi=" + ndi
				+ ", ndivalue=" + ndivalue + ", gender=" + gender + ", birthDate=" + birthDate + ", maritalStatus="
				+ maritalStatus + ", telhome=" + telhome + ", telmobile=" + telmobile + ", telwork=" + telwork
				+ ", email=" + email + ", line=" + line + ", city=" + city + ", givenc=" + givenc + ", familyc="
				+ familyc + ", telc=" + telc + ", relationship=" + relationship + ", managingOrganization="
				+ managingOrganization + ", blood=" + blood + ", id=" + id + ", confirmPassword=" + confirmPassword
				+ "]";
	}
